...
export default function Footer() {
  ...
  const supportLinks = f?.supportLinks && f.supportLinks.length > 0 ? f.supportLinks : [
    { label: 'Contact', url: '/contact' }, { label: 'Legal Notice', url: '#' }, { label: 'Privacy Policy', url: '/privacy-policy' }, { label: 'Terms and Conditions', url: '/terms-conditions' }, { label: 'Sitemap', url: '/sitemap.xml' }
  ]
  ...
  const bottomLinks = f?.bottomLinks && f.bottomLinks.length > 0 ? f.bottomLinks : [
    { label: 'Privacy', url: '/privacy-policy' }, { label: 'Terms', url: '/terms-conditions' }, { label: 'Site Map', url: '/sitemap.xml' }
  ]
